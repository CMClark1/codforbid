...
You can install the development version of codforbid from [GitHub](https://github.com/) with:
...
An example of how to use the DO_RATIOS.R function to calculate the landings multiplier for a given dataset: 
